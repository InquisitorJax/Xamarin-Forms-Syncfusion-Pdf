	...
	sealed partial class App : Application
	{
		...
		protected override void OnLaunched(LaunchActivatedEventArgs e)
		{
			...
			if (rootFrame == null)
			{
				...
				Xamarin.Forms.DependencyService.Register<IAnalyseImageCommand, Wibci.Xamarin.Images.UWP.UWPAnalyseImageCommand>();
				Xamarin.Forms.DependencyService.Register<IImageUtility, WindowsImageUtility>();
